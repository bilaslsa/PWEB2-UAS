...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{ asset('dashboard/images/logos/seodashlogo.png') }}" />
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.html" class="text-nowrap logo-img">
            <img src="{{ asset('dashboard/images/logos/logo-light.svg') }}" alt="" />
          </a>
            ...
            <div class="unlimited-access hide-menu bg-primary-subtle position-relative mb-7 mt-7 rounded-3">
              <div class="d-flex">
                ...
                <div class="unlimited-access-img">
                  <img src="{{ asset('dashboard/images/backgrounds/rocket.png') }}" alt="" class="img-fluid">
                </div>
              </div>
            </div>
          </ul>
